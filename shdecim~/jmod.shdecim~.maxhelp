...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "signal" ],
					"patching_rect" : [ 266.0, 323.0, 300.0, 70.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "@description", "A wrapper for soundhack's +decimate~." ],
					"bgmode" : 1,
					"id" : "obj-1",
					"maxclass" : "bpatcher",
...
, 			{
				"name" : "jmod.shdecim~.maxpat",
				"bootpath" : "/Users/nilspeters/Documents/gits/Jamoma/UserLib/SoundhackWrappers/shdecim~",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
...
, 			{
				...
				"patcherrelativepath" : "../../../Modules/Modular/Max/modules/audio/input~",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
...
, 			{
				...
				"patcherrelativepath" : "../../../Modules/Modular/Max/modules/audio/output~",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
