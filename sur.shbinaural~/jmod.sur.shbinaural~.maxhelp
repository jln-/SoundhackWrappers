...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 433.0, 462.0, 105.0, 18.0 ],
					"text" : "/numSpeakers 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 433.0, 439.0, 188.0, 20.0 ],
					"text" : "jcom.initialized /sur.output~ 500"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 433.0, 325.0, 187.0, 20.0 ],
					"text" : "route /headtracker/azimuth"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 433.0, 352.0, 189.0, 46.0 ],
					"text" : "set xyz 100 0 0 0 2, set orientation 100 $1 0, rename 100 listener"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 202.0, 585.0, 181.0, 60.0 ],
					"text" : "/sur.output~/audio/active 1, /sur.output~/audio/gain 70 ramp 1000, /sur.input~/loop 1, /sur.input~/play 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 383.0, 652.0, 191.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 202.0, 559.0, 146.0, 18.0 ],
					"text" : "/sur.input~/open anton.aif"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 202.0, 525.0, 141.0, 18.0 ],
					"text" : "/sur.setup/preset/recall 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 23.0, 498.0, 194.0, 145.0 ],
					"text" : "To binauralize a stereo file:\n\n1. initialize /sur.setup with:\n\n2. load the stereo file \n     e.g., anton.aif\n\n3. listen over headphones:\n\npay ATTENTION to the loudness!!"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 433.0, 486.0, 300.0, 70.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 132.0, 135.0, 20.0 ],
...
,
					"patching_rect" : [ 247.0, 173.0, 51.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 37.0, 166.0, 167.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 37.0, 76.0, 150.0, 70.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 433.0, 126.0, 300.0, 70.0 ],
					"presentation_rect" : [ 0.0, 0.0, 300.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					"args" : [ "@name", "jmod.sur.shbinaural~", "@description", "binauralization using Soundhack's +binaural~ for up to 16 channels." ],
					"bgmode" : 1,
					"id" : "obj-1",
					"maxclass" : "bpatcher",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "audio.connect" ],
					"patching_rect" : [ 433.0, 249.0, 300.0, 70.0 ],
					"presentation_rect" : [ 0.0, 0.0, 300.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 70.0, 427.0, 168.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 37.0, 206.0, 209.0, 209.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 46.5, 161.0, 256.5, 161.0 ],
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 211.5, 548.5, 392.5, 548.5 ],
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 211.5, 580.0, 392.5, 580.0 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 211.5, 649.0, 392.5, 649.0 ],
					"source" : [ "obj-18", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 256.5, 241.5, 442.5, 241.5 ],
					"source" : [ "obj-22", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 141.5, 421.0, 79.5, 421.0 ],
					"source" : [ "obj-3", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 79.5, 468.0, 252.5, 468.0, 252.5, 241.0, 442.5, 241.0 ],
					"source" : [ "obj-6", 0 ]
				}
...
, 			{
				...
				"patcherrelativepath" : "../../../Modules/Modular/Max/modules/spatialization/sur.input~",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
